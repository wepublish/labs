...
| `lib/execution-labels.ts` | `lib/execution-labels.test.ts` | Scout run outcome semantics: new units, already-known units, unchanged pages, not-relevant criteria misses, and changed-but-unusable pages |
